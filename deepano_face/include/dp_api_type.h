...
typedef enum {
	...
	DP_CMD_UPDATE_MODEL_PNET=72,
	DP_CMD_UPDATE_MODEL_RNET=73,
	DP_CMD_UPDATE_MODEL_ONET=74,
	DP_CMD_UPDATE_MODEL_FNET=75,
}dp_command_t;
