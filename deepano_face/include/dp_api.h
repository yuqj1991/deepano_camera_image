...
* \returns 0 if sucess, <0 if error occured.
*/
EXTERN DLL int dp_send_second_image_num(int box_num);
...
EXTERN DLL int dp_update_pmodel(const char* filename);
EXTERN DLL int dp_update_rmodel(const char* filename);
EXTERN DLL int dp_update_omodel(const char* filename);
EXTERN DLL int dp_update_fmodel(const char* filename);
